...
class NgToggleComponent {
    ...
    get labelLeftStyle() {
        return Object.assign(Object.assign({}, this.labelStyle), { textAlign: this.textAlign.checked || this.textAlign });
    }
    get labelRightStyle() {
        return Object.assign(Object.assign({}, this.labelStyle), { textAlign: this.textAlign.unchecked || this.textAlign });
    }
    get colorChecked() {
        let { color } = this;
        if (!isObject(color)) {
